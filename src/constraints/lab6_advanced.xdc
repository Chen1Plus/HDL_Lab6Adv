...
set_property PACKAGE_PIN W16 [get_ports {sw_speed[2]}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[2]}]
set_property PACKAGE_PIN W17 [get_ports {sw_speed[3]}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[3]}]
set_property PACKAGE_PIN W15 [get_ports {sw_speed[4]}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[4]}]
set_property PACKAGE_PIN V15 [get_ports {sw_speed[5]}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[5]}]
set_property PACKAGE_PIN W14 [get_ports {sw_speed[6]}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[6]}]
set_property PACKAGE_PIN W13 [get_ports {sw_speed[7]}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[7]}]
set_property PACKAGE_PIN V2 [get_ports {sw_speed_max}]
   set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed_max}]
# set_property PACKAGE_PIN T3 [get_ports {sw_speed[9]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[9]}]
# set_property PACKAGE_PIN T2 [get_ports {sw_speed[10]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[10]}]
# set_property PACKAGE_PIN R3 [get_ports {sw_speed[11]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[11]}]
# set_property PACKAGE_PIN W2 [get_ports {sw_speed[12]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[12]}]
# set_property PACKAGE_PIN U1 [get_ports {sw_speed[13]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {sw_speed[13]}]
set_property PACKAGE_PIN T1 [get_ports {enable_distance}]
   set_property IOSTANDARD LVCMOS33 [get_ports {enable_distance}]
